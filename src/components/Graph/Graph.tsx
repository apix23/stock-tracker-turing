...
const Graph = ({ stockSymbol }: GraphProps) => {
  const liveDataUrl = `https://sandbox.iexapis.com/stable/stock/${stockSymbol}/intraday-prices/?token=Tpk_095b8e5990924d0c8c41c2209556da53&chartInterval=5&chartIEXWhenNull=true`
  const yesterdayDataUrl = `https://sandbox.iexapis.com/stable/stock/${stockSymbol}/chart/date/20211109?token=Tpk_095b8e5990924d0c8c41c2209556da53&chartInterval=5&chartIEXWhenNull=true`
